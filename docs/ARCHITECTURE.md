...
- **Componentes muito grandes**: `StrategySummaryModal.jsx` (1116 linhas), `AiStrategyBox.jsx` (1016), `Analyses.jsx` (922). `AthleteDetail.jsx` (697) foi quebrado na spec 013 em `PersonDetail` + `components/person/*`.
