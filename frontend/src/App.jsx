        ...
        <div className={isAuthPage ? '' : 'mx-auto w-full max-w-[1500px] px-4'}>
          ...
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route path="/athletes/:id" element={<ProtectedRoute><PersonDetail type="athlete" /></ProtectedRoute>} />
              <Route path="/opponents" element={<ProtectedRoute><Opponents /></ProtectedRoute>} />
              <Route path="/opponents/:id" element={<ProtectedRoute><PersonDetail type="opponent" /></ProtectedRoute>} />
